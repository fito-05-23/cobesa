...
class AppState:
    def __init__(self):
        ...
        self._current_page = "escritorio"
        self._menu_bgcolor = ft.colors.PRIMARY_CONTAINER  # Color de fondo del menú
        self._header_bgcolor = ft.colors.PRIMARY  # Color de fondo del header
        self._footer_bgcolor = ft.colors.SURFACE  # Color de fondo del footer
        self._body_bgcolor = ft.colors.BACKGROUND  # Color de fondo del body
    ...
    def set_menu_bgcolor(self, color):
        self._menu_bgcolor = color

    def set_header_bgcolor(self, color):
        self._header_bgcolor = color

    def set_footer_bgcolor(self, color):
        self._footer_bgcolor = color

    def set_body_bgcolor(self, color):
        self._body_bgcolor = color
